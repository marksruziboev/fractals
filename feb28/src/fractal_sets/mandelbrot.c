...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/28 13:53:16 by maruzibo          #+#    #+#             */
...
/* mandelbrot:
*   Checks whether a complex number is part of the Mandelbrot fractl or not.
...
*   the Mandelbrot fractl, which can then be used to determine coloring.
*/
...
/*
    ...
    the fractl. If the result stays small over several iterations, the number
    is part of the fractl.
    ...
    Examples with regular numbers:
        ex.: c = 1
            ...
            Z = 26 * 26 + 1 = 677
            ... Grows to infinity.
            So 1 is NOT part of the Mandelbrot fractl.
        ...
        ex.2: c = -1
            ...
            So -1 is part of the Mandelbrot fractl.
    ...
    the number won't be part of the Mandelbrot fractl.

    Since we are worhing with complex numbers, we need to calculate the
