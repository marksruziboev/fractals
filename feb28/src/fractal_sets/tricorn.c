...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/28 13:53:21 by maruzibo          #+#    #+#             */
...
/* tricorn:
*	Checks whether a complex number is part of the Tricorn fractl or not.
...
*	the Tricorn fractl, which can then be used to determine coloring.
*/
