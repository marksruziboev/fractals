...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/19 16:48:54 by maruzibo          #+#    #+#             */
/*   Updated: 2023/02/19 18:55:50 by maruzibo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* set_pixel_color:
	...
	Bit shifting:
		...
		- AA >> 24  (0xAA000000)
*/
static void	set_pixel_color(t_f *f, int x, int y, int color)
{
...
*/
static int	calculate_fractal(t_f *f, double pr, double pi)
{
	int	nb_iter;
