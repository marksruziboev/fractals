...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/19 16:51:42 by maruzibo          #+#    #+#             */
/*   Updated: 2023/02/19 16:51:48 by maruzibo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_set(t_f *f, char **av)
{
...
static void	get_julia_starting_values(t_f *f, int ac, char **av)
{
	if (f->set != JULIA || ac == 2)
	{
		f->kr = -0.766667;
...
static void	handle_args(t_f *f, int ac, char **av)
{
	get_set(f, av);
	if (f->set != JULIA && ac > 3)
		help_msg(f);
